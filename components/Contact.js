                                ...
                                <Fade bottom duration={2500} distance="40px">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="px-4 pt-4 pb-2">
                                            <button type="button" class="m-auto block py-2 px-2  bg-green-400 hover:bg-green-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                                <ImWhatsapp className='inline mx-3 text-3xl' />WhatsApp
                                            </button>
                                            <button type="button" class="m-auto block my-5 py-2 px-2  bg-green-400 hover:bg-green-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                                ONLINE CHAT SUPPORT
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="div-fix w-full max-w-2xl px-5 py-10 m-auto mt-10 bg-white rounded-lg shadow dark:bg-gray-800">
                                            ...
                                            <div class="grid max-w-xl grid-cols-2 gap-4 m-auto">
                                                ...
                                                <div class="col-span-2 text-right">
                                                    ...
                                                    <button type="submit" class="py-2 px-4  bg-green-400 hover:bg-green-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                                        Send
                                                    </button>
